  ...
  return (
    <AuthProvider>
      ...
      {isAuthPage ? (
        ...
        // Halaman admin sudah punya layout & sidebar sendiri
        <>{children}</>
      ) : (
        ...
        <>
          <div className="min-h-screen grid grid-cols-1 md:grid-cols-[260px_1fr]">
            ...
            {/* Sidebar */}
            <aside
              className={`bg-[var(--card)] border-r-2 border-[#cbd5e1] dark:border-white/[.18] md:sticky md:top-0 md:h-screen md:overflow-y-auto self-start transition-transform duration-300 ease-in-out ${
                sidebarOpen
            ...
            <main className="p-4 md:p-6 pt-16 md:pt-6 relative">{children}</main>
          </div>
